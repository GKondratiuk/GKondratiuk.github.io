<script setup>
import proyecto1 from '/src/assets/atm.png';
import proyecto2 from '/src/assets/bank.jpeg';
import proyecto3 from '/src/assets/pseint.jpg';
...
misProyectos.value = ([
    //esto es un array de objetos que contiene información sobre los proyectos
    {
        ...
        src: proyecto1,
        titulo: "ATM (2023)",
        descripcion: "Realizamos un ATM desde la consola en JAVA durante el curso de introducción a la programación en java en el el programa Codo a Codo",
    ...
    },
    {
        ...
        descripcion: "Con los compañeros de la UTN realizamos un proyecto de sistema bancario con entidad grafica en java",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/usuario/proyecto"
    },
    {
        id: 3,
        src: proyecto3,
        titulo: "Pool de juegos",
        descripcion: "Con los compañeros de la UTN realizamos un Pool de juegos",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/usuario/proyecto"
    }
])
