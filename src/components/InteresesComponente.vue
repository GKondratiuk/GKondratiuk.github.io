...
const intereses = ref([
    'De Momento formandome en la UTN como Tecnico en programación, me gustaría a futuro poder especializarme en el ambito de la Cyber Seguridad.',
    'Apasionado de las Motos, en mis tiempos libres disfruto paseando en ella alejandome de la ciudad. Otros de mis pasatiempos tambien es el ciclismo, actividad que practico con regularidad',
    'Tecnología de Innovación: Me apasiona explorar nuevas tendencias tecnológicas como la inteligencia artificial y el desarrollo de aplicaciones móviles, creo que es elemental estar siempre al tanto de las nuevas tendencias'
]);
</script>
