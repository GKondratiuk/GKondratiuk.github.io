...
const title = 'Guillermo Kondratiuk';
const descripcion = 'Técnico Universitario en Programación - UTN';
const residencia = 'Lanus O., Buenos Aires, Argentina';
const presentacion = 'Hola, Bienvenido a mi portafolio de proyectos. Soy un Estudiante de programación en la Universidad Tecnológica Nacional - Regional San Rafael, Mendoza.';
const redesSociales = [
...
const telefono = '+54 9 1166130360';
</script>
