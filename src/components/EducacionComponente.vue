...
const educacion = ref([
  {fecha: '2024', title: 'Técnicatura Universitaria en Programacion', descripcion: ' Cursé el primeraño de la Disciplina Brindada por la UTN regional San Rafael, Mendoza'},
  {fecha: '2023', title: 'Programa Codo a Codo', descripcion: 'Realicé el curso de introducción a la programación, curso dado por el programa Codo a Codo de la Ciudad Autónoma de Buenos aires',},
  {fecha: '2023', title: 'Desarrollo Full-Stack', descripcion: 'Realicé la Diplomatura de Desarrollo Full-Stack de la UTN Buenos Aires en modalidad virtual',}
]);
</script>
